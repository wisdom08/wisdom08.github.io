...
- 정확하게 잘모르고 넘어갔던 Web Server와 WAS의 개념을 공부했습니다. 다음주에는 Web Application Structure(웹 서비스 기본 설정 구조)에 대해서 공부해볼 계획입니다.

# Feelings

- 한 번 더하니까 좀 이해가 됩니다. 역시 반복이 중요합니다.
- 웹서버와 매일 구동시키는 톰캣의 차이를 정확하게 몰랐는데 이번 기회에 정확하게 차이를 알게 되어서 좋습니다.
